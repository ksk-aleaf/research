...
#TOPIC NAME
CAM_IMG_TOPIC_NAME = "/usb_cam/image_raw"
...
#CAM_IMG_WID = 640
CAM_IMG_WID = 1280
CAM_IMG_HALF_WID = CAM_IMG_WID /2
CAM_IMG_HT = 480
...
IMG_HOR_VIEW_AGL = 180
IMG_HOR_HALF_VIEW_AGL = float(IMG_HOR_VIEW_AGL) / 2
IMG_ELEV_VIEW_AGL = 45
IMG_ELEV_HALF_VIEW_AGL = float(IMG_ELEV_VIEW_AGL) / 2

#THETA IMG
PIXEL_PER_AZIMUTH = int(CAM_IMG_WID / IMG_HOR_VIEW_AGL)

#定数(言語仕様では定数は無く、書き換え可能なので注意)
#ウィンドウの大きさ
WIN_WID = CAM_IMG_WID + CAM_IMG_OFS_X*2
