...
NEAR_RIGHT_ARROW_X = 860
NEAR_RIGHT_ARROW_Y = 20
MIDDLE_RIGHT_ARROW_X = 860
MIDDLE_RIGHT_ARROW_Y = 170
FAR_RIGHT_ARROW_X = 860
FAR_RIGHT_ARROW_Y = 320
...
class CameraWidget(QtGui.QWidget):
    ...
    def __init__(self, cameraDevice, parent=None):
        ...
        #矢印
        self.near_right_arrow_image = QtGui.QImage("/home/user/ros/ui_alt/icon/near_right_arrow.png")
        self.near_right_arrow_point = QtCore.QPoint(NEAR_RIGHT_ARROW_X,NEAR_RIGHT_ARROW_Y)

        #左回転ボタン
        self.left_rotate_button = QtGui.QPushButton("left_rotate",self)
        self.left_rotate_button.setGeometry(20,WINDOW_HEIGHT + 20,50,50)
        self.left_rotate_button.clicked.connect(self.leftRotate)
        
　　　　#右回転ボタン
        self.right_rotate_button = QtGui.QPushButton("right_rotate",self)
        self.right_rotate_button.setGeometry(CAMERA_IMAGE_OFFSET+CAMERA_IMAGE_WIDTH+20,WINDOW_HEIGHT + 20,50,50)
        self.right_rotate_button.clicked.connect(self.leftRotate)
...
　　　　#左回転ボタン        
    ...
    def paintEvent(self, e):
        ...
        #矢印用ペインタ
        right_near_arrow_painter = QtGui.QPainter(self)
        ...
        for h in range(len(source)):
            ...
            if(source[h][2] > 22.5 and source[h][2] <= 67.5):
                right_near_arrow_painter.drawImage(self.near_right_arrow_point,self.near_right_arrow_image)
