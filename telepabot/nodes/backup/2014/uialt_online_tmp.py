...
WINDOW_WIDTH = 1040
WINDOW_HEIGHT = 680
CAMERA_IMAGE_OFFSET = 200
CAMERA_IMAGE_WIDTH = 640
CAMERA_IMAGE_HEIGHT = 480

ARROW_RIGHT_X1_XAXIS = 840
ARROW_RIGHT_X1_YAXIS = 40
ARROW_RIGHT_X2_XAXIS = 840
ARROW_RIGHT_X2_YAXIS = 190
ARROW_RIGHT_X3_XAXIS = 840
ARROW_RIGHT_X3_YAXIS = 340

ARROW_LEFT_X1_XAXIS = 0
ARROW_LEFT_X1_YAXIS = 40
ARROW_LEFT_X2_XAXIS = 0
ARROW_LEFT_X2_YAXIS = 190
ARROW_LEFT_X3_XAXIS = 0
ARROW_LEFT_X3_YAXIS = 340

ARROW_LEFT_ROTATE_XAXIS = 360
ARROW_LEFT_ROTATE_YAXIS = 530

ARROW_FORWARD_XAXIS = 490
ARROW_FORWARD_YAXIS = 530

ARROW_RIGHT_ROTATE_XAXIS = 620
ARROW_RIGHT_ROTATE_YAXIS = 530
...
class CameraWidget(QtGui.QWidget):
	...
	def __init__(self, cameraDevice, parent=None):
		...
		self.label.setGeometry(0, 0, WINDOW_WIDTH, WINDOW_HEIGHT)#最初の二つの引数は画面上のウィンドウの位置
		self.show()
		self.text1 = 'Select'
		...
		self.arrow_right_x1_image = self.arrow_right_x1_image.scaled(200, 100,0,0)
		self.arrow_right_x1_point = QtCore.QPoint(ARROW_RIGHT_X1_XAXIS,ARROW_RIGHT_X1_YAXIS)

		#右矢印2
		self.arrow_right_x2_image = QtGui.QImage("/home/user/ros/ui_alt/icon/arrow_right_x2.png")
		self.arrow_right_x2_image = self.arrow_right_x2_image.scaled(200, 100,0,0)
		self.arrow_right_x2_point = QtCore.QPoint(ARROW_RIGHT_X2_XAXIS,ARROW_RIGHT_X2_YAXIS)

		#右矢印3
		self.arrow_right_x3_image = QtGui.QImage("/home/user/ros/ui_alt/icon/arrow_right_x3.png")
		self.arrow_right_x3_image = self.arrow_right_x3_image.scaled(200, 100,0,0)
		self.arrow_right_x3_point = QtCore.QPoint(ARROW_RIGHT_X3_XAXIS,ARROW_RIGHT_X3_YAXIS)

		#左矢印1
		self.arrow_left_x1_image = QtGui.QImage("/home/user/ros/ui_alt/icon/arrow_left_x1.png")
		self.arrow_left_x1_image = self.arrow_left_x1_image.scaled(200, 100,0,0)
		self.arrow_left_x1_point = QtCore.QPoint(ARROW_LEFT_X1_XAXIS,ARROW_LEFT_X1_YAXIS)

		#左矢印2
		self.arrow_left_x2_image = QtGui.QImage("/home/user/ros/ui_alt/icon/arrow_left_x2.png")
		self.arrow_left_x2_image = self.arrow_left_x2_image.scaled(200, 100,0,0)
		self.arrow_left_x2_point = QtCore.QPoint(ARROW_LEFT_X2_XAXIS,ARROW_LEFT_X2_YAXIS)

		#左矢印3
		self.arrow_left_x3_image = QtGui.QImage("/home/user/ros/ui_alt/icon/arrow_left_x3.png")
		self.arrow_left_x3_image = self.arrow_left_x3_image.scaled(200, 100,0,0)
		self.arrow_left_x3_point = QtCore.QPoint(ARROW_LEFT_X3_XAXIS,ARROW_LEFT_X3_YAXIS)

		#左回転ボタン
		self.left_rotate_icon = QtGui.QIcon(self)
		self.left_rotate_icon.addFile("/home/user/ros/ui_alt/icon/arrow_rotate_left.png")
		self.left_rotate_button = QtGui.QPushButton(self.left_rotate_icon,"",self)
		self.left_rotate_button.setGeometry(ARROW_LEFT_ROTATE_XAXIS,ARROW_LEFT_ROTATE_YAXIS,100,100)
		self.left_rotate_button.clicked.connect(self.leftRotate)
		print("left_rotate_button")
		if self.left_rotate_button == None:
			print("left_rotate_button_none")
				
		#右回転ボタン
		self.right_rotate_icon = QtGui.QIcon(self)
		self.right_rotate_icon.addFile("/home/user/ros/ui_alt/icon/arrow_rotate_right.png")
		self.right_rotate_button = QtGui.QPushButton(self.right_rotate_icon,"",self)
		self.right_rotate_button.setGeometry(ARROW_RIGHT_ROTATE_XAXIS,ARROW_RIGHT_ROTATE_YAXIS,100,100)
		self.right_rotate_button.clicked.connect(self.rightRotate)
				
		#前進ボタン
		self.forward_icon = QtGui.QIcon(self)
		self.forward_icon.addFile("/home/user/ros/ui_alt/icon/arrow_forward.png")
		self.forward_button = QtGui.QPushButton(self.forward_icon,"",self)
		self.forward_button.setGeometry(ARROW_FORWARD_XAXIS,ARROW_FORWARD_YAXIS,100,100)
	...
	def paintEvent(self, e):
		...
		for h in range(len(source)):
			print("draw arrow")
			if(source[h][2] > 22.5 and source[h][2] <= 82.5):
				print("draw arrow left x1")
				arrow_left_x1_painter.drawImage(self.arrow_left_x1_point,self.arrow_left_x1_image)
			elif(source[h][2] > 82.5 and source[h][2] <= 142.5):
				print("draw arrow left x2")
				arrow_left_x2_painter.drawImage(self.arrow_left_x2_point,self.arrow_left_x2_image)
			elif(source[h][2] > 142.5 and source[h][2] <= 202.5):
				print("draw arrow left x3")
				arrow_left_x3_painter.drawImage(self.arrow_left_x3_point,self.arrow_left_x3_image)
			elif(source[h][2] > -82.5 and source[h][2] <= -22.5):
				print("draw arrow right x1")
				arrow_right_x1_painter.drawImage(self.arrow_right_x1_point,self.arrow_right_x1_image)
			elif(source[h][2] > -142.5 and source[h][2] <= -82.5):
				print("draw arrow right x2")
				arrow_right_x2_painter.drawImage(self.arrow_right_x2_point,self.arrow_right_x2_image)
			elif(source[h][2] > -202.5 and source[h][2] <= -142.5):
				print("draw arrow right x3")
				arrow_right_x3_painter.drawImage(self.arrow_right_x3_point,self.arrow_right_x3_image)
