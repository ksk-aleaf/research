                ...
                if listener.frameExists("/%s1" % (frame)):
                    ...
                    for i in range(len(pub_msg1.src)):
                        ...
                        if pub_msg1.src[i].parts == '/%s1' % (frame):
                            ...
                            flag = True
                            pub_msg1.src[i].x     = 320 * (1 - (math.tan(trans[0] / trans[2]) / math.tan(math.radians(31.5))))
                            ...
                            prev_pub_msg1.src[i].x     = 320 * (1 - (math.tan(trans[0] / trans[2]) / math.tan(math.radians(31.5))))
                    ...
                    if flag == False:
                        ...
                        append.x     = 320 * (1 - (math.tan(trans[0] / trans[2]) / math.tan(math.radians(31.5))))
                        ...
                        append1.x     = 320 * (1 - (math.tan(trans[0] / trans[2]) / math.tan(math.radians(31.5))))
                ...
                if listener.frameExists("/%s2" % (frame)):
                    ...
                    for i in range(len(pub_msg2.src)):
                        ...
                        if pub_msg2.src[i].parts == '/%s2' % (frame):
                            ...
                            flag = True
                            pub_msg2.src[i].x     = 320 * (1 - (math.tan(trans[0] / trans[2]) / math.tan(math.radians(31.5))))
                            ...
                            prev_pub_msg2.src[i].x     = 320 * (1 - (math.tan(trans[0] / trans[2]) / math.tan(math.radians(31.5))))
                ...
                if listener.frameExists("/%s3" % (frame)):
                    ...
                    for i in range(len(pub_msg3.src)):
                        ...
                        if pub_msg3.src[i].parts == '/%s3' % (frame):
                            ...
                            flag = True
                            pub_msg3.src[i].x     = 320 * (1 - (math.tan(trans[0] / trans[2]) / math.tan(math.radians(31.5))))
                            ...
                            prev_pub_msg3.src[i].x     = 320 * (1 - (math.tan(trans[0] / trans[2]) / math.tan(math.radians(31.5))))
                ...
                if listener.frameExists("/%s4" % (frame)):
                    ...
                    for i in range(len(pub_msg4.src)):
                        ...
                        if pub_msg4.src[i].parts == '/%s4' % (frame):
                            ...
                            flag = True
                            pub_msg4.src[i].x     = 320 * (1 - (math.tan(trans[0] / trans[2]) / math.tan(math.radians(31.5))))
                            ...
                            prev_pub_msg4.src[i].x     = 320 * (1 - (math.tan(trans[0] / trans[2]) / math.tan(math.radians(31.5))))
