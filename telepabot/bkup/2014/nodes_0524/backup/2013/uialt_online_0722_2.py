...
ARROW_RIGHT_X1_XAXIS = 860
ARROW_RIGHT_X1_YAXIS = 20
ARROW_RIGHT_X2_XAXIS = 860
ARROW_RIGHT_X2_YAXIS = 170
ARROW_RIGHT_X3_XAXIS = 860
ARROW_RIGHT_X3_YAXIS = 320

ARROW_LEFT_X1_XAXIS = 20
ARROW_LEFT_X1_YAXIS = 20
ARROW_LEFT_X2_XAXIS = 20
ARROW_LEFT_X2_YAXIS = 170
ARROW_LEFT_X3_XAXIS = 20
ARROW_LEFT_X3_YAXIS = 320
...
class CameraWidget(QtGui.QWidget):
	...
	def __init__(self, cameraDevice, parent=None):
		...
		#if (!image.isNull()) {
		#	image = image.scaled(50, 50, Qt::KeepAspectRatio, Qt::FastTransformation);
		#}
		self.arrow_right_x1_point = QtCore.QPoint(ARROW_RIGHT_X1_XAXIS,ARROW_RIGHT_X1_YAXIS)

		#右矢印2
		self.arrow_right_x1_image = QtGui.QImage("/home/user/ros/ui_alt/icon/arrow_right_x2.png")
		#if (!image.isNull()) {
		#	image = image.scaled(100, 50, Qt::KeepAspectRatio, Qt::FastTransformation);
		#}
		self.arrow_right_x1_point = QtCore.QPoint(ARROW_RIGHT_X2_XAXIS,ARROW_RIGHT_X2_YAXIS)

		#右矢印3
		self.arrow_right_x1_image = QtGui.QImage("/home/user/ros/ui_alt/icon/arrow_right_x3.png")
		#if (!image.isNull()) {
		#	image = image.scaled(150, 50, Qt::KeepAspectRatio, Qt::FastTransformation);
		#}
		self.arrow_right_x1_point = QtCore.QPoint(ARROW_RIGHT_X3_XAXIS,ARROW_RIGHT_X3_YAXIS)
		...
		#左矢印2
		self.arrow_left_x1_image = QtGui.QImage("/home/user/ros/ui_alt/icon/arrow_left_x2.png")
		#if (!image.isNull()) {
		#	image = image.scaled(100, 50, Qt::KeepAspectRatio, Qt::FastTransformation);
		#}
		self.arrow_left_x1_point = QtCore.QPoint(ARROW_LEFT_X2_XAXIS,ARROW_LEFT_X2_YAXIS)

		#左矢印3
		self.arrow_left_x1_image = QtGui.QImage("/home/user/ros/ui_alt/icon/arrow_left_x3.png")
		#if (!image.isNull()) {
		#	image = image.scaled(150, 50, Qt::KeepAspectRatio, Qt::FastTransformation);
		#}
		self.arrow_left_x1_point = QtCore.QPoint(ARROW_LEFT_X3_XAXIS,ARROW_LEFT_X3_YAXIS)
